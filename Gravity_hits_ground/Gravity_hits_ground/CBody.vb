Public Class CBody
    ...
    Public AngleChange As Double
    Public Middle() As PointF
    Public RaiseDistance As Double
    ...
    Public Sub fall(LeftSide As Boolean, RightSide As Boolean)
        If LeftSide = True Then

        End If
    End Sub
    Sub FallRight(pivot As PointF, g As Graphics)
        g.TranslateTransform(pivot)
        g.RotateTransform(360 - 10)
