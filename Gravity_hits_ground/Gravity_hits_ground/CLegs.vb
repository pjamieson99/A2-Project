Public Class CLegs
    ...
    Public Sub New(x As Integer, rnd As Random, sp As Integer, wait As Integer)
        'set properties
        LXpos = x
        LYpos = 100
        px1 = LXpos
    ...
    Sub Friction()
        If up = True Then
            ...
            py1 = ((p1.X - LXpos) * (-Math.Sin(Speed * increase * Math.PI / 180))) + ((p1.Y - (LYpos + 100)) * Math.Cos(Speed * increase * Math.PI / 180)) + LYpos
            px2 = ((p2.X - LXpos) * Math.Cos(Speed * increase * Math.PI / 180)) + ((p2.Y - (LYpos + 100)) * Math.Sin(Speed * increase * Math.PI / 180)) + LXpos
            py2 = ((p2.X - LXpos) * (-Math.Sin(Speed * increase * Math.PI / 180))) + ((p2.Y - (LYpos + 100)) * Math.Cos(Speed * increase * Math.PI / 180)) + LYpos
