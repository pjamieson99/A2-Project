Public Class CBody
    ...
    End Sub
    Sub FallOver(g As Graphics)

        If Leftside = True And Rightside = False Then
            FallRight(Pivot, g)
        ElseIf Leftside = False And Leftside = True Then
            FallLeft(Pivot, g)
        End If
    ...
    Sub FindFriction(Line As CLeg, Floor As CFloor)
        ...
        If Line.OldPoint1.X - Line.LPx1 > Friction And Form1.CheckFloor(Floor, Line.LPy1) = True Then
                Friction = (Line.OldPoint1.X - Line.LPx1)
            End If

            If Line.OldPoint2.X - Line.LPx2 > Friction And Form1.CheckFloor(Floor, Line.LPy2) = True Then
                Friction = (Line.OldPoint2.X - Line.LPx2)
            End If

            If Line.OldPoint1.X - Line.LPx1 < NegativeFriction And Form1.CheckFloor(Floor, Line.LPy1) = True Then
                NegativeFriction = (Line.OldPoint1.X - Line.LPx1)
            End If

            If Line.OldPoint2.X - Line.LPx2 < NegativeFriction And Form1.CheckFloor(Floor, Line.LPy2) = True Then
