Public Class CLeg
    ...
    Sub FindSideLegisOn(Body As CBody, Floor As CFloor)
        ...
        If CheckFloor(Floor, LPx1) = True And LPx1 < Body.CoM.X Then
            Body.Leftside = True
            Body.LeftMomentum = 0.1

        ElseIf CheckFloor(Floor, LPx1) = True And LPx1 > Body.CoM.X Then
            Body.Rightside = True
        ...
        If CheckFloor(Floor, LPy1) = True Then
            Pivot.X = LPx1
            Pivot.Y = LPy1
            Body.Pivot = Pivot

            If CheckFloor(Floor, LPx2) = True And LPx2 < Body.CoM.X Then
                Body.Leftside = True
                Body.LeftMomentum = 0.1
                If LPx2 > Pivot.X Then
                    ...
                    Body.Pivot = Pivot
                End If
            ElseIf CheckFloor(Floor, LPx2) = True And LPx2 > Body.CoM.X Then
                Body.Rightside = True
                Body.RightMomentum = 0.1
                If LPx2 < Pivot.X Then
                    Pivot.X = LPx2
        ...
        ElseIf CheckFloor(Floor, LPy2) = True Then
            Pivot.X = LPx2
            Pivot.Y = LPy2
            Body.Pivot = Pivot
        End If
