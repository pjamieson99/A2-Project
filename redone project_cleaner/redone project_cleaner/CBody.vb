Public Class CBody
    ...
    Private py1 As Double
    Private py2 As Double
    ...
    Sub FallRight(pivot As PointF, g As Graphics)
        ...
        py1 = ((Bxpos1 - pivot.Y) * (-Math.Sin((10) * AngleIncrease * Math.PI / 180))) + ((Bypos1 - pivot.Y) * Math.Cos((10) * AngleIncrease * Math.PI / 180)) + pivot.Y
        px2 = ((Bxpos2 - pivot.X) * Math.Cos((10) * AngleIncrease * Math.PI / 180)) + ((Bypos2 - pivot.Y) * Math.Sin((10) * AngleIncrease * Math.PI / 180)) + pivot.X
        py2 = ((Bxpos2 - pivot.Y) * (-Math.Sin((10) * AngleIncrease * Math.PI / 180))) + ((Bypos2 - pivot.Y) * Math.Cos((10) * AngleIncrease * Math.PI / 180)) + pivot.Y
